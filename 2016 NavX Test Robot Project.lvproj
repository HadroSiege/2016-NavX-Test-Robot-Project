...
AddOutputFilter chunkFilter
		...
		<Item Name="Support Code" Type="Folder">
			<Item Name="DriveControl.vi" Type="VI" URL="../Support VI&apos;s/Teleop/DriveControl.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Elapsed Times.vi"/>
			<Item Name="NavX Angle Test.vi" Type="VI" URL="../Support VI&apos;s/NavX Angle Test.vi"/>
			<Item Name="NavX Data Processing.vi" Type="VI" URL="../Support VI&apos;s/NavX Data Processing.vi"/>
			<Item Name="navX Library v2.lvlib" Type="Library" URL="../navX Library v2/navX Library v2.lvlib"/>
			<Item Name="NavX Motor Scalar.vi" Type="VI" URL="../Support VI&apos;s/NavX Motor Scalar.vi"/>
			<Item Name="NI WPI Serial USB.lvlib" Type="Library" URL="../NI WPI/NI WPI Serial USB.lvlib"/>
			<Item Name="ObjectAvoid.vi" Type="VI" URL="../Support VI&apos;s/Autonomous/ObjectAvoid.vi"/>
			<Item Name="TankDrive.vi" Type="VI" URL="../Support VI&apos;s/Teleop/TankDrive.vi"/>
			<Item Name="Ultrasonic Sensor Data.vi" Type="VI" URL="../Support VI&apos;s/Ultrasonic Sensor Data.vi"/>
		</Item>
